...
export default function InstallGate({ children }: { children: React.ReactNode }) {
  ...
  if (mode === "pending") return <div className="min-h-dvh bg-[#070b14]" />;
...
function InstallScreen() {
  ...
  return (
    <main className="relative isolate flex min-h-dvh flex-col items-center overflow-x-clip px-6 pt-[max(env(safe-area-inset-top),2rem)] pb-[max(env(safe-area-inset-bottom),2rem)] text-center text-white">
      <DarkBackdrop />
